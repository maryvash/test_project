...
txt_starttest2 = 'Выполните 30 приседаний за 45 секунд. Для этого нажмите кнопку "Начать делать приседания", \nчтобы запустить счётчик приседаний.'
...
txt_hinttest2 = '0'
txt_hinttest3 = '0'
txt_starttest1 = 'Лягте на спину и замерьте пульс за 15 секунд. Нажмите кнопку "Начать первый тест", чтобы запустить таймер.'
txt_starttest3 = 'Лягте на спину и замерьте пульс сначала за первые 15 секунд минуты, затем за последние 15 секунд. \n Нажмите кнопку "Начать финальный тест", чтобы запустить таймер.\n Красным обозначены секунды, в течение которых нужно \n проводить измерения. Результаты запишите в соответствующие поля.'
